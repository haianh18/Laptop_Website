...
<head>
    ...
    <style>
        ...
        .modal-content-custom {
            background-color: rgba(255, 255, 255, 0.9) !important; /* Semi-transparent white content */
            border: 1px solid #007bff; /* Optional: border to make the modal content stand out */
        }
        .modal-header-custom {
                                                            ...
                                                            <form id="updateProductForm"
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-lg-6">
                                                                        ...
                                                                        <div class="form-group">
                                                                            <label for="stockUnitUpdate${pro.id}"><strong>Tồn
                                                                                kho:</strong></label>
                                                                            <input name="stockUnit" type="text"
                                                                                   class="form-control"
                                                                        ...
                                                                        <div class="form-group">
                                                                            <label for="descriptionUpdate${pro.id}"><strong>Mô
                                                                                tả:</strong></label>
                                                                            <textarea class="form-control"
                                                                                      id="descriptionUpdate${pro.id}" cols="10"
                                                                                      rows="5"
                                                                                      name="description" oninput="validateDescription(${pro.id})">${pro.description}</textarea>
                                                                            <div id="descriptionUpdateError${pro.id}"
                                                                                 class="error-message"></div>
                                                                        </div>
                                                                        <div class="form-group mt-1" style="display: none">
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        ...
                                                                        <div
                                                                             id="technicalDetailUpdate">
                                                                            <div class="form-group">
                                                                                <label for="osUpdate${pro.id}"><strong>Hệ điều
                                                                                    hành:</strong></label>
                                                                                <input type="text" class="form-control"
                                                                                       id="osUpdate${pro.id}"
                                                                                       name="operatingSystem"
                                                                                       value="${pro.operatingSystem}" oninput="validateOperatingSystem(${pro.id})">
                                                                                <div id="osUpdateError${pro.id}"
                                                                                     class="error-message"></div>
                                                                            </div>
                                                                            <div class="form-group">
                                                                                <label for="cpuUpdate${pro.id}"><strong>CPU:</strong></label>
                                                                                <input type="text" class="form-control"
                                                                                       id="cpuUpdate${pro.id}" name="cpu"
                                                                                       value="${pro.cpu}" oninput="validateCPU(${pro.id})">
                                                                                <div id="cpuUpdateError${pro.id}"
                                                                                     class="error-message"></div>
                                                                            </div>
                                                                            <div class="form-group">
                                                                                <label for="ramUpdate${pro.id}"><strong>RAM:</strong></label>
                                                                                <input type="text" class="form-control"
                                                                                       id="ramUpdate${pro.id}" name="ram"
                                                                                       value="${pro.ram}" oninput="validateRAM(${pro.id})">
                                                                                <div id="ramUpdateError${pro.id}"
                                                                                     class="error-message"></div>
                                                                            </div>
                                                                            <div class="form-group">
                                                                                <label for="screenUpdate${pro.id}"><strong>Màn
                                                                                    hình:</strong></label>
                                                                                <input type="text" class="form-control"
                                                                                       id="screenUpdate${pro.id}"
                                                                                       name="monitorScale"
                                                                                       value="${pro.monitorScale}" oninput="validateScreen(${pro.id})">
                                                                                <div id="screenUpdateError${pro.id}"
                                                                                     class="error-message"></div>
                                                                            </div>
                                                                            <div class="form-group" style="display: none">
                                                                            ...
                                                                            <div class="form-group h-50" style="display: none">
                                                                ...
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <a type="button" href="#"
                                                                            ...
                                                                            onclick="confirmUpdateModal(${pro.id})"
                                                                    >Lưu
                                                                    </a>
                                                                ...
                                                                <div class="modal fade alert-primary" tabindex="-1"
                                                                     data-keyboard="false"
                                                                     id="confirmUpdateModal${pro.id}">
                                                                    <div class="modal-dialog modal-dialog-centered">
                                                                        <div class="modal-content modal-content-custom">
                                                                            <div class="modal-header modal-header-custom">
                                                                                <h5 id="updateModalTitle${pro.id}" class="modal-title">Thành công</h5>
                                                                            </div>
                                                                            <div class="container"></div>
                                                                            <div id="messageUpdate${pro.id}" class="modal-body">Chỉnh sửa thành công sản phẩm
                                                                            </div>
                                                                            <div id="updateFooter" class="modal-footer">
                                                                                <button type="button" class="btn btn-secondary"
                                                                                        data-dismiss="modal">Đóng
                                                                                </button>
                                                                                <button type="submit"
